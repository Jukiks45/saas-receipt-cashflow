    ...
    <div class="relative bg-white border border-slate-200/80 rounded-2xl overflow-hidden shadow-sm hover:shadow-premium transition-all duration-300">
        ...
        <div class="px-6 pb-6 pt-0 relative flex flex-col sm:flex-row sm:items-end justify-between gap-4 -mt-10 sm:-mt-12 z-10">
            <div class="flex flex-col sm:flex-row items-center sm:items-end gap-4 text-center sm:text-left">
                ...
                <div class="sm:mb-2">
                    <h3 class="text-lg md:text-xl font-bold text-slate-800">Budi Wijaya</h3>
                    <p class="text-xs text-slate-400">Anggota Premium &bull; Terdaftar sejak Jan 2026</p>
                </div>
            </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="text" value="Budi Wijaya" class="w-full bg-slate-50 border border-slate-200 text-xs rounded-xl pl-9 pr-4 py-2.5 text-slate-700 font-medium focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all">
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div class="relative">
                            ...
                            <input type="email" value="budi.wijaya@gmail.com" class="w-full bg-slate-50 border border-slate-200 text-xs rounded-xl pl-9 pr-4 py-2.5 text-slate-700 font-medium focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all">
                        </div>
                    </div>
