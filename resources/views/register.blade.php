...
<div class="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
    <div class="bg-white py-8 px-4 border border-slate-200/80 shadow-premium rounded-2xl sm:px-10">
        <form class="space-y-4" action="#" method="POST" onsubmit="event.preventDefault(); window.location.href='{{ route('login') }}';">
            <!-- Name -->
            <div>
                ...
                <div class="relative">
                    ...
                    <input id="name" name="name" type="text" required placeholder="Budi Wijaya" class="w-full bg-slate-50 border border-slate-200 text-xs rounded-xl pl-9 pr-4 py-2.5 text-slate-700 placeholder-slate-400 focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/10 transition-all duration-200">
                </div>
            </div>
            ...
            <!-- Submit Button (Direct to Login on success simulation) -->
            <div class="pt-2">
        ...
        <div class="mt-6">
            <div class="relative">
                ...
                <div class="relative flex justify-center text-xs">
                    <span class="bg-white px-2 text-[10px] text-slate-400 uppercase tracking-wider">Atau daftar dengan</span>
                </div>
            </div>
