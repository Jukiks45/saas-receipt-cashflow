...
<div class="p-4 border-t border-slate-900 flex items-center justify-between gap-3 bg-slate-950 flex-shrink-0">
    <div class="flex items-center gap-3 min-w-0">
        ...
        <div class="text-left min-w-0">
            <p class="text-xs font-semibold text-white truncate">Budi Wijaya</p>
            <p class="text-[10px] text-slate-500 truncate">Premium Member</p>
        </div>
    </div>
    <a href="{{ route('login') }}" class="text-slate-500 hover:text-rose-400 transition-colors p-1.5 rounded-lg hover:bg-slate-900" title="Keluar">
