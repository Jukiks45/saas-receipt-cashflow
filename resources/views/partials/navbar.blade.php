    ...
    <div class="flex items-center gap-3 md:gap-4">
        ...
        <div class="flex items-center gap-3 group cursor-pointer">
            <div class="text-right hidden md:block">
                <p class="text-xs font-semibold text-slate-800 leading-tight group-hover:text-primary transition-colors">Budi Wijaya</p>
                <p class="text-[10px] text-slate-400">budi.wijaya@gmail.com</p>
            </div>
